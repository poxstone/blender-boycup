...
ENV RENDER_EXPORT="${MODEL3D_PATH}/render/"
...
VOLUME ${MODEL3D_PATH}/render

WORKDIR ${MODEL3D_PATH}
ENTRYPOINT blender --python "${MODEL3D_PATH}/force_gpu.py" -b "${MODEL3D_PATH}/${MODEL3D_FILE}" -x 1 -E "CYCLES" -o "//{MODEL3D_FILE}.mkv" -a;
