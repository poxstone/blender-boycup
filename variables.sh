...
export CLOUD_ML_JOB='{"args":[{ "renders":[ { "bucket_model":"gs://zinc-anvil-320815-3dmodels/3dmodel", "blender_params":"--python ./blender_init.py -b ./main.blend -x 1 -E CYCLES -o ./render/ -a"}] }]}'